...
<div class="about-hero">
  ...
  <h1 class="about-name">Vu Hoai Nam</h1>
...
<div class="about-body">
  <p>I work at the intersection of development and quality — where code meets mindset.</p>
  <p>Having worn many hats — developer, QA lead, business analyst, mentor — I've come to realize that software quality doesn't live in tools or processes, but in how everyone on the team <em>thinks</em> about the product.</p>
  <p><strong>QA Engineer Hub</strong> is where I distill what I know, in the way I wish I had learned it from the start: essence first, technique second. Open-source. Free forever.</p>
</div>

<div class="about-quote">
  <div class="quote-mark">"</div>
  <p>Understand the essence, don't memorize by rote.</p>
</div>
